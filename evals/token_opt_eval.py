...
Usage:
  python3 evals/token_opt_eval.py \\
    --clone-dir /workspace/markethawk \\
    --output-dir evals

Options:
  --clone-dir DIR    Repo root (default: /workspace/markethawk)
  --output-dir DIR   Where to write results/ and reports/ (default: evals)
...
# ── Script directory is evals/; scripts are one level up in scripts/
...
def generate_calibration_scorecard(
    ...
    lines.append("**Script:** `evals/token_opt_eval.py --calibrate`")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by `evals/token_opt_eval.py --calibrate`*")
...
def generate_scorecard(eval_data: dict, output_dir: str, clone_dir: str) -> str:
    ...
    lines.append("**Script:** `evals/token_opt_eval.py`")
    lines.append("")
    lines.append("---")
    lines.append("")
    ...
    lines.append("---")
    lines.append("")
    lines.append("*Generated by `evals/token_opt_eval.py`*")
...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default=None,
                        help="Output base dir (default: <clone-dir>/evals)")
